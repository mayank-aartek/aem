...
$(document).ready(function(){
	...
	//btnID=btnID+1;
	 ...
	 cell5.innerHTML = "<input id='"+btnID+"'  type='button' onClick='taskdescription(this.id)' value='ADD'/> ";
...
<body>
 ...
 -->
			...
			<div id="popup_box">
				<!-- OUR PopupBox DIV-->
					<input type="text" id="taskhour" name="taskhour" required placeholder="write Hours"/><sbr>
